...
public class DrillCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drills.add(new Drill(getString(R.string.drill_dewalt_title), getString(R.string.drill_dewalt_info),R.drawable.dewaltdrill));
        drills.add(new Drill(getString(R.string.drill_makitta_title), getString(R.string.drill_makita_info),R.drawable.makitadrill));
        drills.add(new Drill(getString(R.string.drill_bosch_title), getString(R.string.drill_bosch_info),R.drawable.boschdrill));
